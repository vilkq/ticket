...
REPLACE INTO `ticket_config` (`user`, `pass`, `homepage`, `count`) VALUES
	('ticketman', '5d94a752dff94558f1dc44ad46706b75', 'http://qwut.ru/ticket/', 9);
...
REPLACE INTO `ticket_people` (`id`, `fam`, `name`, `otch`, `month`, `year`, `barnum`) VALUES
	...
	(11, 'Петров', 'Александр', 'Кириллович', 3, 21, '2000689007688');
...
-- Дамп данных таблицы ticket.ticket_region: ~368 rows (приблизительно)
